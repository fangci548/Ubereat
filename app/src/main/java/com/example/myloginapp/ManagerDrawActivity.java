...
import com.example.myloginapp.databinding.ActivityManagerDrawBinding;
...
public class ManagerDrawActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    binding = ActivityManagerDrawBinding.inflate(getLayoutInflater());
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    getMenuInflater().inflate(R.menu.manager_draw, menu);
    return true;
  }
